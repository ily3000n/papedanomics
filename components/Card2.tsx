...
const Card2 = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  <div className='w-fit grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-7 py-5 mx-auto justify-items-center justify-center'>
    {dataWisata.map((wisata, index) => (
      <div 
        key={wisata.id} 
        className='w-full sm:w-[400px] h-auto flex flex-col bg-white rounded-xl drop-shadow-lg'
      >
        <Image
